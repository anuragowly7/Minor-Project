...
public class DonorInfo_Guest extends AppCompatActivity {
    Button back,logout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(DonorInfo_Guest.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(DonorInfo_Guest.this,bloodselection_guest.class);
                startActivity(i);
            }
        });
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(DonorInfo_Guest.this,Homescreen.class);
                startActivity(i);
            }
        });
