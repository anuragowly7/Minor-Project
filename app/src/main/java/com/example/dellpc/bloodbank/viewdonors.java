...
public class viewdonors extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        db=new DatabaseHandler(viewdonors.this,null,null,1);
        final ArrayList<String> dolist=new ArrayList<>();
        final ArrayList<String> mai=new ArrayList<>();
        progressDialog1 = new ProgressDialog(viewdonors.this);
        progressDialog = new ProgressDialog(viewdonors.this);
        ...
        FirebaseDatabase.getInstance().getReference("Registerdata")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        ListAdapter listAdapter=new ArrayAdapter<>(viewdonors.this,android.R.layout.simple_list_item_1,dolist);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(viewdonors.this,AdminDonorInfo.class);
                i.putExtra("userii", mai.get(position));
                startActivity(i);
    ...
    public void onBackPressed() {
        Intent i = new Intent(viewdonors.this,Acceptdonate.class);
        startActivity(i);
    }
}
