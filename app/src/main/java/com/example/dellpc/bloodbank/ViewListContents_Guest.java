...
public class ViewListContents_Guest extends AppCompatActivity {
    DatabaseHandler db;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(ViewListContents_Guest.this);
        progressDialog1 = new ProgressDialog(ViewListContents_Guest.this);
        final ListView listview=(ListView)findViewById(R.id.listview);
        String bloodgrp=getIntent().getStringExtra("bloodgrp");
        db=new DatabaseHandler(ViewListContents_Guest.this,null,null,1);
                    ...
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for(DataSnapshot snapshot:dataSnapshot.getChildren()){
                                ...
                                String address=snapshot.child("addesss").getValue(String.class);
                                if(donor.equals("1")){
                                    Person x = new Person(name,blood,address);
                                    dolist.add(x);
                                    doinfo.add(mail);
                                }
                            }
                            padapter adapter =new padapter(ViewListContents_Guest.this,R.layout.adapter_view_layout,dolist);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                progressDialog.show();
                Intent i = new Intent(ViewListContents_Guest.this,DonorInfo_Guest.class);
    ...
    public void onBackPressed() {
        Intent i = new Intent(ViewListContents_Guest.this,bloodselection_guest.class);
        startActivity(i);
    }
}
